...
pub fn scotby_map_page() -> String {
   r#"
    ...
    <head>
        ...
        <title>Scotby Territory Map</title>
    ...
    <body>
        <div class="header">&nbsp;&nbsp;Scotby Territory Map
        ...
        <div id="docs_container" style="padding: 100px; width: 90%; padding-top: 0 !important; display: flex; flex-wrap: wrap; gap: 40px; overflow-y: auto; height: 1600px; scrollbar-width: none;">
            <!-- <img src="public/storage/scotby/dummy_map.png" width="90%" /> -->
        </div>
        <div style="width: 300px; position: absolute; right: 0; display: flex; align-content: center; padding-right: 40px; text-align: center; gap: 40px; justify-content: center; flex-direction: column; height: 70%;">
         <a style="color: #fff; font-size: 100px; display: flex; align-items: center; height: 275px; border: 2px solid #fff; cursor: pointer; justify-content: center; text-decoration: none;" href="/scotby">Back</a> 
        </div>
    </div>
    </body>
    <script>
